...
import ch.zhaw.bauersteine.model.MailInformation;
...
public class MailValidatorService {
    ...
    public MailInformation validateEmail(String email) {
        return webClient
                ...
                .get()
                // uri to api
                .uri("/api/email/" + email) // Proceed to declare how to extract the response.
                .retrieve()
                // mapping to a certain class
                .bodyToMono(MailInformation.class) // Optional: pass a timeout for the request
